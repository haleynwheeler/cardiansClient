...
login::login(wxFrame* parent): wxPanel(parent,wxID_ANY,wxDefaultPosition,
  ...
  verticalOne->Add(new wxTextCtrl(this,0,"Username",wxDefaultPosition, wxSize(140,60)),1,wxCENTER,0);
  ...
  verticalTwo->Add(new wxTextCtrl(this,0,"Password",wxDefaultPosition, wxSize(140,60)),1,wxCENTER,0);
    wxButton *user = new wxButton(this, newUserButton, wxT("New User"), wxDefaultPosition,
      wxSize(200,100), 0, wxDefaultValidator, wxButtonNameStr);
