...
newUser::newUser(wxFrame* parent): wxPanel(parent,wxID_ANY,wxDefaultPosition,
  ...
  horizontalContainer->Add(new wxTextCtrl(this,0,"Username",wxDefaultPosition, wxSize(140,60)),1,wxCENTER,0);
  ...
  horizontalContainer->Add(new wxTextCtrl(this,0,"Password",wxDefaultPosition, wxSize(140,60)),1,wxCENTER,0);
    wxButton *user = new wxButton(this, newUserButton, wxT("Create New User"), wxDefaultPosition,
      wxSize(280,100), 0, wxDefaultValidator, wxButtonNameStr);
...
wxBEGIN_EVENT_TABLE (newUser, wxPanel)
    ...
    EVT_BUTTON(newUserButton, newUser::OnNewUser)
wxEND_EVENT_TABLE()
