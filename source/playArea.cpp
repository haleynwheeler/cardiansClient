...
void playArea::dummyPopUp() {
  // wxPopupTransientWindow *dummy = new wxPopupTransientWindow(GetParent());
  // dummy->Popup();
  // dummy->Dismiss();
  //  wxMessageDialog dialog(NULL, "Dummy", "Stupid", wxYES_NO);
  // GetParent()->ProcessPendingEvents();
  //  wxGUIEventLoop dummy();
  // dummy.Exit();
  // dialog.ShowModal();
  // dialog.Show(true);
  // dialog.Show(false);
