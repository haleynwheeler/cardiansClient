...
playArea::playArea(wxFrame* parent): wxPanel(parent,wxID_ANY,wxDefaultPosition,
    wxDefaultSize, wxTAB_TRAVERSAL, wxPanelNameStr)
  {
    int cardWidth = 20;
    int cardHeight = 100;
    ...
    wxBitmapButton *topLogo = new wxBitmapButton(this, wxID_ANY, wxBitmap("TextLogo.png", wxBITMAP_TYPE_PNG),
    ...
    wxBitmapButton *Discard = new wxBitmapButton(this, wxID_ANY, wxBitmap("white.jpg", wxBITMAP_TYPE_JPEG),
      ...
      wxBitmapButton *card1 = new wxBitmapButton(this, wxID_ANY, wxBitmap(upFull,
    ...
    wxBitmapButton *card3 = new wxBitmapButton(this, wxID_ANY, wxBitmap("upFull.jpg", wxBITMAP_TYPE_JPEG),
      wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, wxButtonNameStr);
    playerTwo->Add(card3);
    for(int i= 0; i<12;i++){
